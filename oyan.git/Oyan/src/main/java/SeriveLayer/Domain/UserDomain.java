...
public class UserDomain extends BaseDomain {
    ...
    private WakeUpDomain wakeupDomain;

    public WakeUpDomain getWakeupDomain() {
        return wakeupDomain;
    }

    public void setWakeupDomain(WakeUpDomain wakeupDomain) {
        this.wakeupDomain = wakeupDomain;
    }
